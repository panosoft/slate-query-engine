...
var _user$project$Slate_Schema$eventMap = F2(
	function (entitySchema, propertySchema) {
		var propertyEvents = _elm_lang$core$List$concat(
			A2(
				_elm_lang$core$List$map,
				function (_) {
					return _.eventNames;
				...
				propertySchema));
		var entityEvents = entitySchema.eventNames;
...
var _user$project$Json_JsonHelper_ops = _user$project$Json_JsonHelper_ops || {};
_user$project$Json_JsonHelper_ops['<||'] = _elm_lang$core$Json_Decode$object2(
	F2(
		function (x, y) {
			return x(y);
		}));
var _user$project$Json_JsonHelper_ops = _user$project$Json_JsonHelper_ops || {};
_user$project$Json_JsonHelper_ops['//'] = _elm_lang$core$Basics$flip(_elm_lang$core$Maybe$withDefault);
var _user$project$Json_JsonHelper_ops = _user$project$Json_JsonHelper_ops || {};
_user$project$Json_JsonHelper_ops['///'] = F2(
	function (decoder, $default) {
		return A2(
			...
			function (maybe) {
				return _elm_lang$core$Json_Decode$succeed(
					A2(_user$project$Json_JsonHelper_ops['//'], maybe, $default));
			});
	});
...
var _user$project$Slate_Event$eventDataDecoder = A2(
	_user$project$Json_JsonHelper_ops['<||'],
	A2(
		_user$project$Json_JsonHelper_ops['<||'],
		A2(
			_user$project$Json_JsonHelper_ops['<||'],
...
_user$project$Postgres_Postgres_ops['&>>'] = F2(
	function (t1, f) {
...
var _user$project$Postgres_Postgres$State = F2(
	function (a, b) {
		return {nextId: a, connections: b};
	});
var _user$project$Postgres_Postgres$init = _elm_lang$core$Task$succeed(
	A2(_user$project$Postgres_Postgres$State, 0, _elm_lang$core$Dict$empty));
var _user$project$Postgres_Postgres$Client = {ctor: 'Client'};
var _user$project$Postgres_Postgres$NextQuery = F3(
	function (a, b, c) {
		return {ctor: 'NextQuery', _0: a, _1: b, _2: c};
	});
var _user$project$Postgres_Postgres$nextQuery = F3(
	function (connectionId, errorTagger, tagger) {
		return _user$project$Postgres_Postgres$command(
			A3(_user$project$Postgres_Postgres$NextQuery, connectionId, errorTagger, tagger));
	});
var _user$project$Postgres_Postgres$StartQuery = F5(
	function (a, b, c, d, e) {
		return {ctor: 'StartQuery', _0: a, _1: b, _2: c, _3: d, _4: e};
	});
var _user$project$Postgres_Postgres$startQuery = F5(
	function (connectionId, sql, recordCount, errorTagger, tagger) {
		return _user$project$Postgres_Postgres$command(
			A5(_user$project$Postgres_Postgres$StartQuery, connectionId, sql, recordCount, errorTagger, tagger));
	});
var _user$project$Postgres_Postgres$Disconnect = F4(
	function (a, b, c, d) {
...
var _user$project$Postgres_Postgres$disconnect = F4(
	function (connectionId, discardConnection, errorTagger, tagger) {
		return _user$project$Postgres_Postgres$command(
			A4(_user$project$Postgres_Postgres$Disconnect, connectionId, discardConnection, errorTagger, tagger));
	});
var _user$project$Postgres_Postgres$Connect = F7(
	function (a, b, c, d, e, f, g) {
		return {ctor: 'Connect', _0: a, _1: b, _2: c, _3: d, _4: e, _5: f, _6: g};
	});
...
var _user$project$Postgres_Postgres$connect = F7(
	function (host, port$, database, user, password, errorTagger, tagger) {
		return _user$project$Postgres_Postgres$command(
			A7(_user$project$Postgres_Postgres$Connect, host, port$, database, user, password, errorTagger, tagger));
	});
var _user$project$Postgres_Postgres$Stream = {ctor: 'Stream'};
var _user$project$Postgres_Postgres$ErrorQuery = F3(
	function (a, b, c) {
		return {ctor: 'ErrorQuery', _0: a, _1: b, _2: c};
	});
var _user$project$Postgres_Postgres$SuccessQuery = F3(
	function (a, b, c) {
		return {ctor: 'SuccessQuery', _0: a, _1: b, _2: c};
	});
var _user$project$Postgres_Postgres$ErrorDisconnect = F2(
	function (a, b) {
		return {ctor: 'ErrorDisconnect', _0: a, _1: b};
	});
var _user$project$Postgres_Postgres$SuccessDisconnect = function (a) {
	return {ctor: 'SuccessDisconnect', _0: a};
};
var _user$project$Postgres_Postgres$ErrorConnect = F2(
	function (a, b) {
		return {ctor: 'ErrorConnect', _0: a, _1: b};
	});
var _user$project$Postgres_Postgres$SuccessConnect = F2(
	function (a, b) {
		return {ctor: 'SuccessConnect', _0: a, _1: b};
	});
			...
			case 'Connect':
				...
				return {
					...
					_0: A7(
						...
						A2(
							settings1,
							_user$project$Postgres_Postgres$ErrorConnect(connectionId),
							_user$project$Postgres_Postgres$SuccessConnect(connectionId)),
						_user$project$Postgres_Postgres$connectionTimeout,
						_p21._0,
						_p21._1,
						_p21._2,
						_p21._3,
					...
					function (connection) {
						return {
							...
							_0: A3(
								...
								A2(
									settings0,
									_user$project$Postgres_Postgres$ErrorDisconnect(_p22),
					...
					function (connection) {
						return {
							...
							_0: A4(
								...
								A2(
									settings2,
									A2(_user$project$Postgres_Postgres$ErrorQuery, _p24, _p27),
									_user$project$Postgres_Postgres$SuccessQuery(_p24)),
								connection.client,
								_p27,
								_p26),
							_1: A3(
								...
								_elm_lang$core$Native_Utils.update(
									connection,
									{
										sql: _elm_lang$core$Maybe$Just(_p27),
					...
					function (connection) {
						var stream = function () {
							...
							if (_p28.ctor === 'Just') {
								...
								return A2(
									...
									A2(
										_elm_lang$core$Basics_ops['++'],
										'Missing Stream connectionId: ',
										_elm_lang$core$Basics$toString(_p30)),
									_user$project$Postgres_Postgres$Stream);
							}
						}();
						var recordCount = function () {
							var _p29 = connection.recordCount;
							if (_p29.ctor === 'Just') {
								return _p29._0;
							} else {
								return A2(
									...
									A2(
										_elm_lang$core$Basics_ops['++'],
										'Missing Record Count connectionId: ',
										_elm_lang$core$Basics$toString(_p30)),
									0);
							}
						}();
						...
						return {
							...
							_0: A4(
								...
								A2(
									settings2,
									A2(_user$project$Postgres_Postgres$ErrorQuery, _p30, sql),
									_user$project$Postgres_Postgres$SuccessQuery(_p30)),
								connection.client,
								stream,
								recordCount),
							_1: state
		...
		function (query, depth, dict) {
			...
			if (_p18.ctor === 'Node') {
				return A3(
					...
					_p18._0,
					depth,
					A3(addChildren, _p18._1, depth + 1, dict));
			} else {
				return A3(add, _p18._0, depth, dict);
			}
		});
	var addChildren = F3(
		function (children, depth, dict) {
			...
			if (_p19.ctor === '::') {
				return A3(
					...
					_p19._0,
					depth,
					A3(addChildren, _p19._1, depth, dict));
			} else {
				return dict;
			}
		});
			...
			return _elm_lang$core$Basics$snd(
				A2(
					...
					A2(
						...
						function (_p20) {
							var _p21 = _p20;
							return _elm_lang$core$Native_Utils.eq(_p21._0, schema);
						},
	...
	function (depthDict, parentChild) {
		var build = F2(
			function (depth, templates) {
				build:
				while (true) {
					var maxIdSQLClause = _elm_lang$core$Native_Utils.eq(depth, 0) ? 'CROSS JOIN (SELECT MAX(id) FROM events) AS q\n' : '';
					var maxIdColumn = _elm_lang$core$Native_Utils.eq(depth, 0) ? ', q.max' : '';
				...
				F2(
					function (_p25, dict) {
						...
						return A3(
							_elm_lang$core$Dict$insert,
							_p26._1,
							A2(_user$project$Slate_Query$MessageDictEntry, nodeQuery.msg, _p26._0),
							dict);
					}),
				dict,
		...
		function (query, dict) {
			...
			if (_p27.ctor === 'Node') {
				return A3(
					...
					A2(addToDict, _p27._0, dict),
					_p27._1);
			} else {
				return A2(addToDict, _p27._0, dict);
			}
		});
									...
									return function (j) {
										return function (k) {
											return function (l) {
												return function (m) {
													return function (n) {
														return {query: a, badQueryState: b, currentTemplate: c, templates: d, rootIds: e, ids: f, additionalCriteria: g, maxIds: h, firstQueryMaxId: i, errorMsg: j, eventProcessingErrorMsg: k, completionMsg: l, tagger: m, messageDict: n};
													};
												};
											};
										};
...
var _user$project$Slate_Engine$startQuery = F3(
	function (model, queryStateId, connectionId) {
		...
		var firstQuery = _elm_lang$core$Native_Utils.eq(queryState.currentTemplate, 0);
		var firstQueryMaxCriteria = firstQuery ? '' : A2(
			_elm_lang$core$Basics_ops['++'],
			'AND id < ',
			...
			A2(
				...
				function (template) {
					...
					var sqlTemplate = A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								{ctor: '_Tuple2', _0: 'firstQueryMaxCriteria', _1: firstQueryMaxCriteria},
					...
					var sql = A4(
						...
						sqlWithEntityIds);
					var ll = A2(_elm_lang$core$Debug$log, sql, 'sql');
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
...
var _user$project$Test_App$eventMsgDispatch = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: _user$project$Test_App$MutatePerson, _1: _user$project$PersonEntity$eventMap},
		{ctor: '_Tuple2', _0: _user$project$Test_App$MutateAddress, _1: _user$project$AddressEntity$eventMap}
	]);
